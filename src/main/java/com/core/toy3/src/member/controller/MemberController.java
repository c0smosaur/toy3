...
public class MemberController {
  ...
  // spring validation 필요?
  @PostMapping("/sign-up")
  public Response<MemberResponse> signUp(@RequestBody MemberRequest member) throws Exception {
  ...
  public Response<String> logout(HttpSession session) throws Exception{
    ...
    // session 존재하지 않을 때 예외 발생 -> spring security로 인가 없을 때는 접근제한
  }
}
